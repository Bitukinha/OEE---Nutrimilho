...
const useDevProxy =
  import.meta.env.DEV && import.meta.env.VITE_SUPABASE_USE_PROXY === "true";

const SUPABASE_URL = useDevProxy
...
const SUPABASE_KEY = useDevProxy
  ? "dev-proxy"
...
if (
  !SUPABASE_URL ||
  (!useDevProxy && !SUPABASE_URL.startsWith("https://"))
) {
  console.error(
